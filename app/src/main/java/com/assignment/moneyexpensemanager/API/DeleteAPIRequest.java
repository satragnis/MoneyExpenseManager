...
//        Log.d(TAG, "request: pardashdasmas "+params.toString());
//        //Requesting with post body as params
//        JsonObjectRequest postRequest = new JsonObjectRequest(Request.Method.DELETE, url, params,
...
////                params.put("app-v", Params.DEVICE_TYPE);
